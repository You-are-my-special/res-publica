...
Github has a lot of issues. Issues related to bugs, features, and more. You can issues as a table view. This is actually great, you have a lot of information already.

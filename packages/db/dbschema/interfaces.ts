...
export namespace $default {
  ...
  export interface GitHubUser extends std.$Object {
  ...
  export interface Gravitas extends std.$Object {
    "createdAt"?: Date | null;
    "score"?: number | null;
  }
  ...
  export interface Reaction extends std.$Object {
  ...
  export interface Repo extends std.$Object {
    "languages": Language[];
    "owner": Owner;
    "topics": Topic[];
    "createdAt"?: Date | null;
...
import GitHubUser = $default.GitHubUser;
import Gravitas = $default.Gravitas;
...
export interface types {
  ...
  "default": {
    ...
    "GitHubUser": $default.GitHubUser;
    "Gravitas": $default.Gravitas;
    "Issue": $default.Issue;
    "Label": $default.Label;
